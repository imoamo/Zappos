        ...
        <>
            <Box className={Styles.parent}>
                <Text
                    ...
                    textAlign={'center'} className={Styles.heading}>Shop Popular Categories</Text>
                <SimpleGrid columns={{
                    base: 2,
                    md: 3,
                    lg: 4,
            ...
            <Box className={Styles.parent_2}>
                ...
                <SimpleGrid columns={{
                    ...
                    lg: 3,
                    xl: 4
                }} spacing={'5rem'} className={Styles.grid_2}
            ...
            <Box className={Styles.container_3}>
                ...
                >
                    <Box w={{ '2xl': '33%' }} p={5} className={Styles.flex_1_child}


                    >
                        <Text  fontSize={{base:'2rem',md:"2.5rem",lg:'3rem','2xl':'4rem'}} className={Styles.flex_h1}>Dolce Vita Dreamin'</Text>
                        <Text
                         fontSize={{base:'1.8rem',md:"2rem",lg:'2.5rem','2xl':'3rem'}}
                        className={Styles.flex_h2}>Mellow out with luxurious styles that transport you to your happy place.</Text>
                ...
                >
                    ...
                    <Box w={{ '2xl': '33%' }} p={5} className={Styles.flex_2_child}>
                        <Text  fontSize={{base:'2rem',md:"2.5rem",lg:'3rem','2xl':'4rem'}} className={Styles.flex_2_h1}>THE STYLE ROOM</Text>
                        <Text  fontSize={{base:'1.8rem',md:"2rem",lg:'2.5rem','2xl':'3rem'}} className={Styles.flex_2_h2} >Footwear Favorites</Text>
                        <Text  
                         fontSize={{base:'1.6rem',md:"2rem",lg:'2.3rem','2xl':'2.5rem'}}
                        className={Styles.flex_2_h3}>Enhance your look with shoes that your provide timeless style for any occasion.</Text>
