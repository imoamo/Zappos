...
const Product = () => {
    ...
    function AddToCart(element) {
        ...
        let cartIems = JSON.parse(localStorage.getItem('cartItems')) || [];
        let cartLength = cartIems.length || 0;

        cartIems.push(element);
        cartLength = cartIems.length;
        localStorage.setItem('cartItems', JSON.stringify(cartIems));
